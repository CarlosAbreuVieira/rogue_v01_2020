...
import pt.upskills.projeto.objects.Statics.BuildingScene.ExplositionGif;
        ...
        while (control) {
            ...
            try {
                if (fireTile.validateImpact()) {
                    ...
                    ExplositionGif explositionGif = new ExplositionGif(fireTile.getPosition());
                    Engine.gui.addImage(explositionGif);
                    sleep(500);
                    Engine.gui.removeImage(explositionGif);
                    control = false;
                }
